...
class Preprocessor:
    ...
    # function for getting appropriate training images
    def preprocess_train_images(self, number=-1, visualize=False, with_hog_features=False):
        ...
        # filter the digits we want (2,3,8,9)
        ...
        # if the given parameter number is -1 then we just put directly the value of digit(either 2,3,8,9)
        # if not then if the digit is equal to given parameter then we add 1 otherwise we add -1
        if number == -1:
        ...
        # based on the given with_hog_features parameter we either apply feature extraction or not
    ...
    # function for getting appropriate test images
